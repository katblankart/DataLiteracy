...
The study is based on data from the National Ambulatory Medical Care Survey (NAMCS) 2014. The NAMCS is a national sample survey administered by the National Center for Health Statistics. It collects data on patient visits to non-federally employed physicians in the United States. For each visit, the physician or other staff members have to complete a one-page survey form containing patient demographics, including the patients’ insurance status, diagnoses, types of health behavior counselling or medications ordered or provided as well as provider characteristics. As the physicians are randomly chosen and randomly assigned to a two-week reporting period, the NAMCS is able to create a nationally representative sample. The NAMCS data contain all actions taken by a physician in this period and, thus, allows to control for physician-specific behavior. This is necessary to draw conclusions of our estimand, namely the effect of the patient’s insurance status. With the following equation we can calculate the estimate of the insurance status: 
