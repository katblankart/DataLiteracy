...
**C**	* different drug classes *
**X**	* patient demographics *
**P**	* insurance categories *
**S**	* indicator if the physician is a specialist *
**R**	* region *
**¯X**	* average patient characteristics in one practice*
**¯P**	* average of physicians patients in each insurance category *
...
The choice of choice of the covariates depends on the underlying causal model that is rooted by theoretical considerations.
