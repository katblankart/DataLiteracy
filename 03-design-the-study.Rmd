...
Most secondary data is collected retrospectively and thus will not allow performing a RCT. You will not be able to randomly assign subjects ahead of time, such that you typically need to search for the best available quasi-experiment to identify treatment effects using a
...
The study is based on data from the National Ambulatory Medical Care Survey (NAMCS) 1991. The NAMCS is a national sample survey administered by the National Center for Health Statistics. The NAMCS data contain all actions taken by a physician in this period and, thus, allows to control for physician specific behaviour. This is necessary to draw conclusions of our estimand, namely the effect of the patient’s insurance status. 
...
Contrary to Hellerstein (1998), this equation leaves out indicators for mandatory substitution laws, $M$ and $T$, as this was information of the confidential data files. Hellerstein describes that she uses a random effects probit specification at physician level, however the specified equation looks different than the usual random effects specification. You can find more information on random effect models in Cameron and Trivedi [@book].
