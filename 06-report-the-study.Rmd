...
In the following, we go over each chapter to highlight its contribution to Hellerstein’s research article. The structure of Hellerstein (1998) contains the following chapters: 
