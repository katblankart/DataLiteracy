...
- use present tense, that means *"in this paper I attempt to..."*, *"Hellerstein (1998) finds that..."* -- even though it was a while ago; *"Table 1 shows..."*, not *"Table 1 will show..."*
- generally stick to one tense
- use active voice
- use in-text citations, that means *"Hellerstein (1998) finds that..."* 
