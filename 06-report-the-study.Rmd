...
- keep it short. When editing always ask yourself whether you can make the same point using fewer words. Is your writing clear, concise (not too wordy) and easy to follow?
...
### General guidance on the use of language in the research paper ([Lund Uniiversity](https://www.awelu.lu.se/language/register-and-style/dos-donts/))

- Do not use slang, jargon, or colloquialisms. Always us formal language.
...
- Do not use needless words and information that clutter the writing. Make your writing clear and concise. For example, change *“in order to” to “to”, ”whether or not” to “whether”, “is equal to” to “equals”, “it should be noted” to “notably”.* Remove repetitive and redundant information.
...
- Do not plagiarize. Provide references and citations whenever you say something that is not your own.
- Do not take for granted that the spell check on your computer is accurate or will spot all spelling
...
- use present tense: *"in this paper I attempt to..."*, *"Hellerstein (1998) finds that..."* -- even though it was a while ago; *"Table 1 shows..."*, not *"Table 1 will show..."*
...
- place minor or secondary details and digressions from the main paragraph into footnotes, but use them sparingly.
