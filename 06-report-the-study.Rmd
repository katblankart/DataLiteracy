...
|--------------------------------|-------------------------------------------|-------------------------------------------|----------------------------|
|     Constant                   |     -0.611***                             |     (-3.30)                               |         -                  |
|     Age                        |     -0.003*                               |     (-2.44)                               |     -0.001*                |
|     Female                     |     -0.114**                              |     (-3.12)                               |     -0.029**               |
|     Hispanic                   |     0.029                                 |     (0.34)                                |     0.007                  |
|     Nonwhite                   |     0.067                                 |     (1.00)                                |     0.017                  |
|     Specialist                 |     -0.009                                |     (-0.12)                               |     -0.002                 |
|     Mean age                   |     -0.002                                |     (-0.75)                               |     -0.000                 |
|     Percent female             |     -0.206                                |     (-1.30)                               |     -0.052                 |
|     Percent black              |     -0.007                                |     (-0.04)                               |     -0.002                 |
|     Percent Hispanic           |     -0.142                                |     (-0.57)                               |     -0.036                 |
|     Percent Medicaid           |     0.091                                 |     (0.39)                                |     0.023                  |
|     Percent Medicare           |     -0.124                                |     (-0.58)                               |     -0.031                 |
|     Percent private insured    |     0.179                                 |     (1.30)                                |     0.045                  |
|     Percent HMO/prepaid        |     0.054                                 |     (0.31)                                |     0.014                  |
|     Midwest                    |     -0.158                                |     (-1.71)                               |     -0.040                 |
|     South                      |     -0.178*                               |     (-1.99)                               |     -0.045*                |
|     West                       |     0.059                                 |     (0.61)                                |     0.015                  |
|     rho                        |     0.345                                 |                                           |                            |
...
|-------------------------------------|------------------------------------------|---------------------------------------|----------------------------|
|     Antimicrobials                  |     0.637***                             |     9.02                              |     0.160***               |
|     Cardiovascular-renals           |     -0.106                               |     -1.29                             |     -0.0267                |
|     Central Nervous System          |     0.101                                |     1.10                              |     0.0253                 |
|     Hormones/Hormonal mechanisms    |     0.589***                             |    7.32                               |     0.148***               |
|     Skin/Mucous membrane            |     -0.721***                            |     -6.45                             |     -0.181***              |
|     Ophthalmics                     |     -0.351*                              |     -2.33                             |     -0.0883*               |
|     Resperatory tract               |     -0.691***                            |     -5.02                             |     -0.174***              |
