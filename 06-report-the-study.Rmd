...
We briefly summarize each of these items (the following is based on [Cochrane, 2005](http://mayoral.iae-csic.org/timeseries_bgse13/phd_paper_writing.pdf), [Martin, 2018](https://www.youtube.com/watch?v=Vky9PDKx5KU), and [Nikolov, 2020](https://mpra.ub.uni-muenchen.de/105088/1/MPRA_paper_105088.pdf)).
...
The **Abstract** is usually around 100-150 words and includes a very short summary of your research question, main contribution, data and methods used, main findings, and conclusions.

The **Introduction** is said to the most important part of the paper as it has to grab the readers' attention. It should motivate your research topic and give a more extensive overview of the context, data, methods and findings. You should provide context by referencing the existing literature regarding the things that we know and things that we do not know and then parlay the latter part into your research question. You need to raise the interest of your readers to a degree that they would want to continue reading the rest of your paper. The **Introduction** should be written at the very end and should not take up more than 3 pages. 
...
The **Data** and variables section should contain a detailed information about the data sources used in the paper as well as information about the variables used in the analysis.

Describe the data you are using in your study in great detail. Is it a secondary data? Did you collect it yourself? If yes, how? Describe your sample and variable selection, provide descriptive statistics and graphs.

The **Empirical method** section should in great detail describe the statistical method used in the paper and the assumptions that are necessary to be fulfilled in order to get an unbiased and consistent estimation of your parameter of interest. Also describe the empirical problems and how you address them.
...
The **Results** section should contain a set of tables and figures that show your main empirical results. Explain the economic significance of your results, not just their statistical significance. Make sure that tables are reader-friendly and are easy to comprehend. Place figures and tables as close as possible to the place in the text where you first refer to them. Follow the main results with limited responses to potential criticisms and robustness checks (most of these should go in your Appendix). 
...
- Shorter is better: keep the paper short as possible. Every word must count. When editing always ask yourself whether you can make the same point with fewer words. Is your writing clear, concise and easy to follow? 
