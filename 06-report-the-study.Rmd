...
- read the text yourself and let others read it. (*"Is the text fun to read?"*, *"Would you want to read beyond the introduction yourself?"*, *"Are the questions guiding the research comprehensible?"*)
...
Table 2 shows very similar statistics for the patients of the NAMCSd sample compared to the 1989 data. We see a $5%$ increase in the proportion of generic drug prescription in specialist compared to @hellerstein_importance_1998. Compared to 1989, we observe a slightly smaller sample size in the 1991 data.
