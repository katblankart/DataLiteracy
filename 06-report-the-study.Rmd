...
### The writing process (based on [Cochrane, 2005](http://mayoral.iae-csic.org/timeseries_bgse13/phd_paper_writing.pdf) and [Dudenhefer, 2009](https://econ.duke.edu/sites/econ.duke.edu/files/file-attachments/Dudenhefer%2C%20Paul%20-%20Guide%20to%20Writing%20in%20Economics.pdf))
...
### Tables (based oon [Cochrane, 2005.](http://mayoral.iae-csic.org/timeseries_bgse13/phd_paper_writing.pdf))
...
### Figures (based on [Cochrane, 2005.](http://mayoral.iae-csic.org/timeseries_bgse13/phd_paper_writing.pdf))
...
In the following, we go over each part to highlight its contribution to Hellerstein’s research article. The structure of Hellerstein (1998) contains the following parts: 
...
The paper titel consists of 12 words that reflect the paper's research question.

## Abstract

In the abstract Hellerstein gives a quick overview on her paper by mentioning the topic, the data, the results and their takeaway.


## Introduction

The introduction of Hellerstein is rather short. She starts it by highlighting a welfare-enhancing potential of substituting trade-name drugs with generics, creating relevance for her topic. Next, she elaborates her research question, followed by a short overview of the results and their implications. She finalizes with a structural overview of the rest of her paper.
...
Next, Hellerstein mentions multiple concerns about her model. She addresses them with different robustness checks. 
These include:
...
- 
With that, Hellerstein not only uses her Results chapter to report her findings, but also to discuss their implications and limitations. Commonly, this is usually done in a separate Discussion chapter.
...
Here Hellerstein lists all in-text references used in the paper in alphabetical order. 
