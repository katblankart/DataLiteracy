...
We briefly summarize each of these items (the following is based on [Greg Martin (2018)](https://www.youtube.com/watch?v=Vky9PDKx5KU)).
...
The **Empirical method** section should in great detail describe the statistical method used in the paper and the assumptions that are necessary to be fulfilled in order to get an unbiased and consistent estimation of your parameter of interest. Also describe the limitations and how you address them.
...
The **Results** section should contain a set of tables and figures that show your empirical results. Make sure that tables are reader-friendly and are easy to comprehend. Place figures and tables as close as possible to the place in the text where you first refer to them. 


Do not discuss or explain the results in this section, and do not provide any interpretation or speculation here. Keep it factual and simply describe in words what the tables and figures display. 
...
The **Summary and conclusion** section is usually short and contains the most important information on the topic, findings and concluding remarks. It should mirror  main points mentioned in the **Introduction**. 
...
- keep it short. When editing always ask yourself whether you can make the same point with fewer words. Is your writing clear, concise and easy to follow?
- avoid repetition. It uses extra space and tests readers' patience.  
...
### General guidance on writing and use of language in a research paper ([Lund Uniiversity](https://www.awelu.lu.se/language/register-and-style/dos-donts/))
...
- Do not use needless words and information that clutter the writing. Use simple and direct sentences, and keep them short. For example, change *“in order to” to “to”, ”whether or not” to “whether”, “is equal to” to “equals”, “it should be noted” to “notably”.* Remove repetitive and redundant information.
...
- Use in-text citations: *"Hellerstein (1998) finds that..."* 
- Do not mix British and American English, citation styles, tenses, and different word spellings. Be consistent in the use of language and style.
