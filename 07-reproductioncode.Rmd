...
The subsequent Stata program reproduces the empirical analyses of: Hellerstein, Judith K. 1998. “The Importance of the Physician in the Generic versus Trade-Name Prescription Decision.” The RAND Journal of Economics 29(1):108–36. doi: 10.2307/2555818.
...
1. Preparing the data (Section \@ref(run-study))
2. Descriptive statistics (Section \@ref(analyzing))
3. Empirical analyses (Section \@ref(analyzing) and Section \@ref(report-study))
...
//Medicare patients 
gen temp = selfpay + medicaid + other_gov_ins + private_ins + hmo_pre_paid + other_pay
replace medicare = 0 if temp != 0  
drop temp


* 2) Drop observations with unknown payment
drop if unknown_pay == 1 
...
gen specialist = (phys_special == "GP" | phys_special == "FP" | phys_special == "PD") 
gen x = selfpay + medicaid + other_gov_ins + private_ins + hmo_pre_paid + other_pay
replace medicare = 0 if x != 0
...
label variable drug_class_1 "Antimicrobial"
label variable drug_class_2 "Cardiovascular-renals"
label variable drug_class_3 "Central Nervous System"
label variable drug_class_4 "Hormones"
label variable drug_class_5 "Skin/Mucous Membranes"
label variable drug_class_6 "Ophthalmics"
label variable drug_class_7 "Pain Relief"
label variable drug_class_8 "Respiratory Test"
...
****************************
//Dropping conditions
keep if prescription_status == 1 & multisource == 1 & major_drug_class == 1 & order_of_drug == 1 & no_charge == 0 & unknown_pay == 0
...
selfpay medicare medicaid other_gov_ins private_ins hmo_pre_paid no_charge other_pay unknown_pay ///
...
qui eststo table1: estpost summarize age female nonwhite hispanic selfpay medicare medicaid private_ins hmo_pre_paid specialist northeast midwest south west  if no_charge == 0
...
coeflabels(age "Age" female "Female" nonwhite "Nonwhite" hispanic "Hispanic" selfpay "Self-pay" medicare "Medicare" medicaid "Medicaid"  hmo_pre_paid "HMO/prepaid plan" ///
specialist "Specialist" northeast "Northeast" midwest "Midwest" south "South" west "West" ) ///
...
"Age" "Female" "Nonwhite" "Hispanic" "Self-Pay" "Medicare" "Medicaid" "Private" "HMO/prepaid plan" ///
...
global C drug_class_1 drug_class_2 drug_class_3 drug_class_4 drug_class_5 drug_class_6 drug_class_8 /* drug classes */
...
* M and T must be ommitted due to missing state id
...
esttab c_1 m_1 c_2 m_2 c_3 m_3 c_4 m_4 c_5 m_5 c_6 m_6 c_7 m_7 c_8 m_8 using Table6.rtf, replace ///
...
mtitle("Antimicrobial" "m1" "Cardiovaskulars" "m2" "Central Nervous System" "m3" "Hormones" " m4" "Skin/Muchous Membranes" "m5" "Ophthalmics" ///
"m6" "Pain relief" "m7" "Respiratory Tract" "m8" ) nonumbers eqlabels(none) collabels(none) nonumbers compress



* Tables 7, 8 and 9 are not reproducible, due to missing state id in the publically available data sets
```
